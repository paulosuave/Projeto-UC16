<%-- 
    Document   : curso
    Created on : 20/11/2021, 09:39:19
    Author     : Suave
--%>
            ...
            <div class="col-md-6">
                <form action="CursoServlet" method="POST"  style="background-color:#DCDCDC; padding: 30px; margin: 50px;">
                    ...
                    <div class="form-group">
                        ...
                        <input  required id="txtnome" name="nome" class="form-control"  type="text" placeholder="Insira o Nome do Curso" > 
                    </div>



                    <div class="form-group">
                        <label iid="lblhoras" for="txthoras">Horas</label>
                        <input class="form-control"  required id="txthoras" name="horas" type="text" placeholder="Insira o tempo do curso em horas">
                    </div>
