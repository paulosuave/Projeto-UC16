<%-- 
    ...
    Created on : 12/12/2021, 14:50:01
    Author     : Suave
--%>
                ...
                <div class="container" style="background-color:#DCDCDC; padding: 30px; margin: 50px;">
                    ...
                    <table class="table table-striped">
                        ...
                        <%         for (int i = 0; i < cursos.size(); i++) {
                                ...
                                out.print("<td>");
                                out.print(cursos.get(i).getHoras());
                                out.print("</td>");

                                out.print("<td >");
                                out.print("<form action='editarcurso.jsp'>");
                                out.print("<button  name='editar' value='" + cursos.get(i).getId() + "' type='submit' class='btn btn-primary mb-2'>Editar</button>");
                                out.print("</form>");
                                out.print("</td>");
